...
var ICON_PATHS = {
  ...
  // Nouveaux — couvrent les emojis restants dans les templates
  ...
  // Nouveaux — emojis restants
  robot:      '<rect x="3" y="8" width="18" height="13" rx="2"/><path d="M12 5a2 2 0 1 0 0-4 2 2 0 0 0 0 4zm0 0v3"/><circle cx="9" cy="14" r="1.2" fill="currentColor"/><circle cx="15" cy="14" r="1.2" fill="currentColor"/><path d="M9 18h6"/>',
  sun:        '<circle cx="12" cy="12" r="5"/><line x1="12" y1="1" x2="12" y2="3"/><line x1="12" y1="21" x2="12" y2="23"/><line x1="4.22" y1="4.22" x2="5.64" y2="5.64"/><line x1="18.36" y1="18.36" x2="19.78" y2="19.78"/><line x1="1" y1="12" x2="3" y2="12"/><line x1="21" y1="12" x2="23" y2="12"/><line x1="4.22" y1="19.78" x2="5.64" y2="18.36"/><line x1="18.36" y1="5.64" x2="19.78" y2="4.22"/>',
  moon:       '<path d="M21 12.79A9 9 0 1 1 11.21 3 7 7 0 0 0 21 12.79z"/>',
  trophy:     '<polyline points="6 9 6 2 18 2 18 9"/><path d="M6 18H4a2 2 0 0 1-2-2v-1a2 2 0 0 1 2-2h16a2 2 0 0 1 2 2v1a2 2 0 0 1-2 2h-2"/><rect x="6" y="18" width="12" height="4"/>',
  ...
  userSingle: '<path d="M20 21v-2a4 4 0 0 0-4-4H8a4 4 0 0 0-4 4v2"/><circle cx="12" cy="7" r="4"/>',
  graduation: '<path d="M22 10v6M2 10l10-5 10 5-10 5z"/><path d="M6 12v5a6 6 0 0 0 12 0v-5"/>',
  ...
  handshake:  '<path d="M3 11l5-5h3l5 5M14 6l2-2h2l3 3-3 2h-2"/><path d="M3 11l9 9 9-9"/><line x1="12" y1="20" x2="12" y2="11"/>',
  ...
  magnet:     '<path d="M6 15A6 6 0 1 0 18 15"/><line x1="6" y1="15" x2="6" y2="20"/><line x1="18" y1="15" x2="18" y2="20"/><line x1="9" y1="20" x2="15" y2="20"/>',
  // Affichage
...
var EMOJI_FALLBACK = {
  ...
  settings:'',  send:'',    archive:'',   more:'⋮',
  download:'',  alertTri:'', collab:'',    plus:'',
  edit:'',      trash:'',   check:'✔',      checkCircle:'',
  x:'✕',        xCircle:'✕',  clock:'',     filter:'',
  upload:'',    phone:'',   mail:'',       linkedin:'',
  note:'',      copy:'',    external:'',   link:'',
  chevronL:'←', chevronR:'→', chevronD:'▾',   chevronU:'▴',
  moreH:'···',  list:'☰',   grid:'▦',        cards:'',
  alert:'',     info:'',    star:'',       bell:'',
  flag:'',      home:'',
  lock:'',      camera:'', eye:'',         tag:'',
  globe:'',     chat:'',   tool:'',        mapPin:'',
  folder:'',    shuffle:'', zap:'',         bulb:'',
  paperclip:'',
  robot:'',    sun:'',      moon:'',      trophy:'',   briefcase:'',
  sparkles:'',  refreshCw:'', hourglass:'', eyeOff:'',
  key:'',      save:'',    printer:'',  clipboard:'',
  trendingUp:'', userSingle:'', graduation:'', ban:'',
  activity:'',  smartphone:'', gamepad:'',  handshake:'',
  coffee:'',   magnet:'',
};

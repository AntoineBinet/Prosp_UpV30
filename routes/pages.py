    ...
    pages: list[dict] = [
        ...
        },
        {
            ...
            "actions": [
                ...
                {"label": "Meilleurs candidats par prospect (IA-classés)", "href": "/v30/sourcing",
                 "tools": {"handlers": ["quickRescoreCandidates", "applyCandidatesResult"], "endpoints": ["GET /api/prospect/<id>/best-candidates?use_ollama=1&ai_explanations=1"], "backend": ["app.py:api_prospect_best_candidates", "utils/tech_synonyms.are_synonyms"]}},
                ...
                {"label": "Enrichir la fiche depuis un document (IA)", "href": "/v30/candidat/<id>",
                 "tools": {"handlers": ["openEnrichModal", "renderDcEnrichFields", "applyDcEnrich"], "endpoints": ["POST /api/candidate-attachments/<aid>/enrich", "POST /api/candidates/<id>/dc-enrich", "PUT /api/candidates/<id>"], "backend": ["routes/candidates.py:api_candidate_attachment_enrich", "routes/candidates.py:api_candidate_dc_enrich"]}},
        ...
        # ─── OUTILS ────────────────────────────────────────────
        {
            ...
            "actions": [
                ...
                {"label": "Plan IA du push (secteur · catégorie · candidats)", "href": "/v30/push",
                 "tools": {"handlers": ["runAIPlan", "applyPlanEvent", "renderAIPlan", "applyCandidatesResult"], "endpoints": ["GET /api/prospect/<id>/push-ai-plan"], "backend": ["routes/push.py:api_prospect_push_ai_plan", "services/push_ai.py:stream_push_ai_plan", "services/push_ai.py:gather_plan_input"]}},
        ...
        },
        {
            ...
            "summary": "Arborescence métiers v6 — arbre courbe catégorie → métier, panneau détail drill-in, recherche, export JSON, classification IA des tags.",
            "actions": [
                {"label": "Rechercher un métier", "href": "/v30/metiers",
                 "tools": {"handlers": ["applySearch"], "endpoints": [], "backend": []}},
                {"label": "Sélectionner un métier dans l'arbre", "href": "/v30/metiers",
                 "tools": {"handlers": ["selectMetier", "updateDetail", "refreshPaths"], "endpoints": [], "backend": []}},
                {"label": "Basculer vue Arbre/Liste/Matrice", "href": "/v30/metiers",
                 "tools": {"handlers": ["bindSeg"], "endpoints": [], "backend": []}},
                {"label": "Ajouter un métier custom (admin)", "href": "/v30/metiers",
                 "tools": {"handlers": ["bindCustom"], "endpoints": ["GET /api/custom_metiers", "POST /api/custom_metiers", "DELETE /api/custom_metiers/<id>"], "backend": ["app.py:api_custom_metiers"]}},
                ...
                {"label": "Exporter JSON métiers", "href": "/v30/metiers",
                 "tools": {"handlers": ["bindExport"], "endpoints": [], "backend": []}},
            ],
        },

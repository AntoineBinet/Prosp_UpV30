    ...
    pages: list[dict] = [
        ...
        # ─── RECORDS ───────────────────────────────────────────
        {
            ...
            "actions": [
                ...
                {"label": "Tri par score IA dans Mode Prosp", "href": "/v30/prospects/mode-prosp",
                 "tools": {"handlers": ["loadDeck"], "endpoints": ["GET /api/prospects/scores"], "backend": ["routes/prospect_score.py:api_prospects_scores"]}},
